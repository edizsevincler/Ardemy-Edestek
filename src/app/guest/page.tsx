    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-3">
        <Link
          ...
          className="rounded-lg bg-gradient-to-r from-brand-600 to-brand-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition hover:from-brand-500 hover:to-brand-400"
        >
          Soru Bankasına Git
        </Link>
        <Link
          href="/guest/credits"
          className="rounded-lg bg-gradient-to-r from-gold-500 to-gold-400 px-4 py-2 text-sm font-semibold text-brand-950 shadow-sm transition hover:from-gold-400 hover:to-gold-300"
        >
          Kredi Satın Al
        </Link>
      </div>
